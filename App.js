  ...
  return (
    <View style={styles.heads}>
      <View style={styles.head}>
        <Button title="F-LIGHT" disabled={main} onPress={toflight} color="green"/>
        <Button title="COUNTER" disabled={main} onPress={tocounter} color="green" />
      </View>
